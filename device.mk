...
# Kernel
$(call inherit-product, $(LOCAL_PATH)/kernel/KernelProduct.mk)
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/privapp-permissions-org.lineageos.fire.aodguard.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/privapp-permissions-org.lineageos.fire.aodguard.xml
